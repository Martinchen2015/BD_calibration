...
%   C = cconvfft2(A, B)	convolves A and B using the larger size
%
%   C = cconvfft2(A, B, N)   convolves A and B using size N
%
%   C = cconvfft2(A, B, N, adj)  convolves A and B using size N, adj is a
...
%   Both N and adj can be left empty.
    ...
    if numvararg >= 2 && ~isempty(varargin{2})
        ...
        elseif strcmp(varargin{2}, 'both')
            ...
            error('Invalid selection for adj.');
        end
    end
